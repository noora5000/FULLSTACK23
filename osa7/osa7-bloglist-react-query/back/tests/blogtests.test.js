...
describe("author with most blogs", () => {
  test("is able to find the author with most blogs", () => {
    ...
    expect(mostBlogsAuthor.author).toEqual("Robert C. Martin") &&
      mostBlogsAuthor.blogs.toEqual(3);
  });
});
...
describe("author with most likes", () => {
  test("is able to find the author with most likes", () => {
    ...
    expect(mostLikesAuthor.author).toEqual("Edsger W. Dijkstra") &&
      mostLikesAuthor.likes.toEqual(17);
  });
});
